...
//    Xóa danh sách hóa đơn bán hàng
    ...
    private void initComponents() {
        ...
        txtTimDonHoan.setHintText("Nhập mã đơn hoàn");
        ...
        btnChiTietDonHoan.setText("Xem chi tiết đơn hoàn");
        ...
        tblHoaDonHoan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã đơn hoàn", "Mã hóa đơn", "Ngày hoàn đơn", "Tổng sản phẩm", "Tổng tiền hoàn", "Tên khách hàng", "Tên nhân viên"
            }
        ));
...
//    Tìm kiếm danh sách hóa đơn theo quý
